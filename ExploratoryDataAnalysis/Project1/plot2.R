...
## 5) makes Plot 2 on the screen device
...
# renames GAP and selects the necessary variables

data2 <- select(data, gap = Global_active_power, dow, datetime)
...
plot(data2$datetime, data2$gap, type="l", ylab = "Global Active Power (kilowatts)",
     xlab="")

# saves it to a file
dev.copy(png, file = "plot2.png")  ## Copy the plot to a PNG file, default is 480x480
